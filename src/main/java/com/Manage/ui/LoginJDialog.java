  ...
  void checkTaiKhoan(){
       ...
       if(tk == null){
           ...
           if(!password.equals(txtPass.getText())){
              ...
              Auth.user = tk;
//              String tenDangNhap = Auth.user.getUsername();
...
//               } else {
//                    new HomeKHangJDialog(null, true).setVisible(true);
//                   //new HomeNewJPanel(null, true).setVisible(true);
//               }
           }
       }  
   }
